...
- the release version, such as `0.2.3-local`;
...
docker pull nguyenson1710/pipeforge-api:0.2.3-local
```
...
```text
gh attestation verify oci://ghcr.io/jasontm17/pipeforge-api:0.2.3-local -R JasonTM17/PipeForge
```
...
recorded in [the 0.2.3 container evidence](../release/container-0.2.3-evidence.md).
