...
func DefaultTopology() Topology {
	return Topology{
		...
		Queues: []Queue{
			...
			{Name: "control-plane.dispatch", DeadLetter: "control-plane.dispatch.dlq"},
			{Name: "control-plane.workers", DeadLetter: "control-plane.workers.dlq"},
			{Name: "control-plane.results", DeadLetter: "control-plane.results.dlq"},
			{Name: "audit.events"}, {Name: "monitoring.events"},
			{Name: "processing.jobs.dlq"}, {Name: "processing.cancellations.dlq"}, {Name: "control-plane.dispatch.dlq"}, {Name: "control-plane.workers.dlq"}, {Name: "control-plane.results.dlq"},
		},
		Bindings: []Binding{
			...
			{CommandsExchange, "control-plane.dispatch", "processing.job.queued"},
			{EventsExchange, "control-plane.workers", MessageWorkerRegistered},
			{EventsExchange, "control-plane.workers", MessageWorkerHeartbeat},
			{EventsExchange, "control-plane.results", MessageJobStarted},
			{EventsExchange, "control-plane.results", MessageJobProgressed},
			{EventsExchange, "control-plane.results", MessageJobSucceeded},
			{EventsExchange, "control-plane.results", MessageJobFailed},
			{EventsExchange, "control-plane.results", MessageJobCancelled},
			...
			{DeadLetterExchange, "control-plane.dispatch.dlq", "control-plane.dispatch.dlq"},
			{DeadLetterExchange, "control-plane.workers.dlq", "control-plane.workers.dlq"},
