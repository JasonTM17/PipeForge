...
func TestLoadUsesDefaults(t *testing.T) {
	...
	if cfg.MinIOEndpoint == "" || cfg.MinIOAccessKey == "" || cfg.MinIOSecretKey == "" || cfg.DatasetBucket != defaultDatasetBucket || cfg.MaxUploadBytes != defaultMaxUploadBytes || cfg.MultipartPartSize != defaultMultipartPartSize || cfg.MultipartMaxParts != defaultMultipartMaxParts || cfg.MultipartMaxBytes != defaultMultipartMaxBytes || cfg.MultipartSessionTTL != defaultMultipartSessionTTL || cfg.MultipartURLTTL != defaultMultipartURLTTL || cfg.MultipartCleanupLimit != defaultMultipartCleanupLimit {
...
func TestLoadParsesOverrides(t *testing.T) {
	...
	if cfg.DatabasePort != 55433 || cfg.DatabaseMaxConns != 4 || cfg.ShutdownTimeout != 3*time.Second || cfg.AccessTokenTTL != 10*time.Minute || cfg.RefreshTokenTTL != 48*time.Hour || cfg.MinIOEndpoint != "minio:9000" || !cfg.MinIOSecure || cfg.MaxUploadBytes != 1048576 || cfg.MultipartPartSize != 5242880 || cfg.MultipartMaxParts != 1000 || cfg.MultipartMaxBytes != 5242880000 || cfg.MultipartSessionTTL != 12*time.Hour || cfg.MultipartURLTTL != 10*time.Minute || cfg.MultipartCleanupLimit != 25 {
